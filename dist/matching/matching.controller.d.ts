...
export declare class MatchingController {
    ...
    getMatchScore(user: any, matchedUserId: string): Promise<any>;
    getUserMatchScores(user: any, limit?: string): Promise<any>;
    getReverseMatches(user: any, limit?: string): Promise<{
        profile: {
            user: {
                email: string | null;
                mobile: string | null;
