...
export declare class InterestsService {
    ...
    sendInterest(fromUserId: string, toUserId: string, message?: string): Promise<{
        fromUser: {
            profile: {
                photos: {
                    url: string;
    ...
    rejectInterest(userId: string, interestId: string): Promise<{
        message: string;
        alreadyProcessed: boolean;
    } | {
        message: string;
    ...
    withdrawInterest(userId: string, interestId: string): Promise<{
        message: string;
    }>;
    getInterestHistory(userId: string, filters?: {
        status?: string;
        type?: 'sent' | 'received';
    }): Promise<({
        fromUser: {
    ...
    getPendingInterestsReminder(userId: string): Promise<{
        count: number;
        interests: ({
            fromUser: {
                profile: {
    ...
    getInterestStats(userId: string): Promise<{
        sent: number;
        received: number;
        accepted: number;
        rejected: number;
    ...
    sendBulkInterests(fromUserId: string, userIds: string[], message?: string): Promise<{
        total: number;
        successful: number;
        failed: number;
        results: any[];
