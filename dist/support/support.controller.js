...
let SupportController = class SupportController {
    ...
    async createSupportTicket(user, body) {
        return this.supportService.createSupportTicket(user.id, body.subject, body.message, body.category, body.priority);
    }
...
], SupportController.prototype, "createSupportTicket", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SupportController.prototype, "getFAQ", null);
__decorate([
