...
export declare class FamilyController {
    ...
    getFamilyMembers(user: any): Promise<{
        name: string;
        email: string | null;
        mobile: string | null;
        password: string | null;
    ...
    updateFamilyMember(user: any, id: string, body: {
        name?: string;
        canViewMatches?: boolean;
        canSendInterests?: boolean;
        canChat?: boolean;
    ...
    deleteFamilyMember(user: any, id: string): Promise<{
        message: string;
    }>;
    loginFamilyMember(body: {
