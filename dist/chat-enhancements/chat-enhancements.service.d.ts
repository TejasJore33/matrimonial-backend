...
export declare class ChatEnhancementsService {
    private prisma;
    constructor(prisma: PrismaService);
    getMessageTemplates(userId: string, category?: string): Promise<{
        name: string;
        id: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    createMessageTemplate(userId: string, name: string, content: string, category?: string): Promise<any>;
    updateMessageTemplate(userId: string, templateId: string, name?: string, content?: string, category?: string): Promise<any>;
    deleteMessageTemplate(userId: string, templateId: string): Promise<any>;
    getIceBreakers(userId: string, profileId: string): Promise<{
        defaultQuestions: string[];
        savedBreakers: any;
    }>;
    saveIceBreaker(userId: string, profileId: string, question: string, answer?: string): Promise<any>;
    getChatReminders(userId: string): Promise<{
        chatId: string;
        otherUser: {
            profile: {
                photos: {
