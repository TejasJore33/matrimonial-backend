...
export declare class ChatController {
    ...
    getOrCreateChatWithUser(user: any, otherUserId: string): Promise<{
    ...
    getChat(user: any, id: string): Promise<{
        currentUserId: string;
        otherUser: {
            profile: {
                photos: {
    ...
    sendMessage(user: any, id: string, body: {
        content?: string;
        imageUrl?: string;
        videoUrl?: string;
        audioUrl?: string;
    ...
    deleteMessage(user: any, id: string, forEveryone?: string): Promise<{
        message: string;
    }>;
    reportMessage(user: any, id: string, body: {
        reason: string;
    }): Promise<{
        message: string;
    }>;
    searchMessages(user: any, id: string, query: string, page?: string, limit?: string): Promise<{
        messages: ({
            sender: {
                profile: {
                    firstName: string;
